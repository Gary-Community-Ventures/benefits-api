...
urlpatterns = [
    ...
    path("admin/warning_messages", views.warning_messages_view),
    path("admin/warning_messages/filter", views.warning_messages_filter_view),
    path("admin/warning_messages/create", views.create_warning_message_view),
    path("admin/warning_messages/<int:id>", views.warning_message_view),
