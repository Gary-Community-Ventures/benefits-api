    ...
    def eligible(self) -> Eligibility:
        ...
        def income_eligible(member):
            ...
            income_limit = (
                ...
                * MedicaidAdultWithDisability.max_income_percent
            )
            ...
            earned = max(
                ...
                int(
                    (
                        int(member.calc_gross_income("yearly", ["earned"]))
                        - earned_deduction
                    )
                    * earned_percent
                ),
            ...
            unearned = (
                int(member.calc_gross_income("yearly", ["unearned"]))
                - unearned_deduction
            )
            ...
            [
                ...
                (
                    lambda m: m.insurance.has_insurance_types(
                        MedicaidAdultWithDisability.insurance_types
                    ),
                    None,
                ),
