...
from programs.programs.policyengine.policyengine import \
    eligibility_policy_engine
...
class CHPTestCase(TestCase):
    def test_chp_single_parent_two_children(self):
        # TODO: why is MEDICAID returning eligible beyond the
        # colorado household income table
