...
class Command(BaseCommand):
    ...
    referral_options = {
        ...
        "taxAssistanceSite": {
            "_label": "referralOptions.taxAssistanceSite",
            "_default_message": "Tax Assistance Site (VITA/Tax Help Colorado)",
        },
    }
    ...
    health_insurance_options = {
        "you": {
            ...
            "none": {
                ...
                "_label": "healthInsuranceOptions.none-I",
                "_default_message": "I do not have health insurance",
            },
            "private": {
            ...
            "dont_know": {
                "icon": {"_name": "Dont_know", "_classname": "option-card-icon"},
                "_label": "healthInsuranceOptions.dont_know",
                "_default_message": "Don't Know",
            },
            "family_planning": {
                "icon": {"_name": "Family_planning", "_classname": "option-card-icon"},
        ...
        "them": {
            ...
            "none": {
                "icon": {"_name": "None", "_classname": "option-card-icon"},
                "_label": "healthInsuranceOptions.none-they",
                "_default_message": "They do not have health insurance",
            },
            "private": {
                "icon": {"_name": "PrivateInsurance", "_classname": "option-card-icon"},
                "_label": "healthInsuranceOptions.private",
    ...
    housing_options = {
        "hotel": {"_label": "housingOptions.hotel", "_default_message": "In a hotel"},
        "owner": {
            "_label": "housingOptions.owner",
            "_default_message": "You or a household member owns the home or apartment",
        },
        "renting": {"_label": "housingOptions.renting", "_default_message": "Renting"},
        "shelter": {
            "_label": "housingOptions.shelter",
            "_default_message": "In a shelter or homeless",
        },
        "preferNotToSay": {
            "_label": "housingOptions.preferNotToSay",
            "_default_message": "Prefer not to say",
        },
        "stayingWithFriend": {
            "_label": "housingOptions.stayingWithFriend",
            "_default_message": "Staying with friend",
        },
    }
    ...
    def handle(self, *args, **options):
        ...
        Configuration.objects.create(
            ...
            data=self.acute_condition_options,
            active=True,
        )

        # Save sign_up_options to database
        Configuration.objects.create(
            name="sign_up_options", data=self.sign_up_options, active=True
        )

        # Save relationship_options to database
        Configuration.objects.create(
            name="relationship_options", data=self.relationship_options, active=True
        )

        # Save referral_options to database
        Configuration.objects.create(
            name="referral_options", data=self.referral_options, active=True
        )

        # Save language_options to database
        Configuration.objects.create(
            name="language_options", data=self.language_options, active=True
        )

        # Save income_options to database
        Configuration.objects.create(
            name="income_options", data=self.income_options, active=True
        )

        # Save health_insurance_options to database
        Configuration.objects.create(
            name="health_insurance_options",
            data=self.health_insurance_options,
            active=True,
        )

        # Save housing_options to database
        Configuration.objects.create(
            name="housing_options", data=self.housing_options, active=True
        )

        # Save frequency_options to database
        Configuration.objects.create(
            name="frequency_options", data=self.frequency_options, active=True
        )

        # Save expense_options to database
        Configuration.objects.create(
            name="expense_options", data=self.expense_options, active=True
        )

        # Save condition_options to database
        Configuration.objects.create(
            name="condition_options", data=self.condition_options, active=True
        )

        # Save co_zipcodes to database
        Configuration.objects.create(
            name="co_zipcodes", data=self.co_zipcodes, active=True
        )

        # Save counties_by_zipcode to database
        Configuration.objects.create(
            name="counties_by_zipcode", data=self.counties_by_zipcode, active=True
        )

        # Save category_benefits to database
        Configuration.objects.create(
            name="category_benefits", data=self.category_benefits, active=True
        )
