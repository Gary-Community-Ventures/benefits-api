...
class Translate:
    ...
    languages: list[str] = [
        ...
        if lang["code"] != settings.LANGUAGE_CODE
    ]
    ...
    def translate(self, lang: str, text: str):
        ...
        if lang not in Translate.languages:
            raise Exception(
                f"{lang} is not configured in settings, or is the default language"
            )

        result = self.client.translate(
            text, target_language=lang, source_language=Translate.main_language
        )
    ...
    def bulk_translate(self, langs: list[str], texts: list[str]):
        ...
        for lang in langs:
            ...
            results = self.client.translate(
                texts, target_language=lang, source_language=Translate.main_language
            )
    ...
    def format_text(self, result):
        ...
        return (
            " " * leading_spaces
            + html.unescape(result["translatedText"])
            + " " * trailing_spaces
        )
